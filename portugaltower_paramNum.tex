...
\begin{table}[ht]
\centering
\caption{Object-specific scalar parameters (\textsf{paramNum}), tower Portugal} 
\label{tab:portugaltower_paramNum}
\begin{tabular}{lrll}
  \hline
...
\verb!bubble! & 8.08 & hPa & PTF by \citet{rawls85} \\ 
  ...
  \verb!crop_makk! & 0.60 & -- & Eq. \eqref{eq:cropmakk} \\ 
  ...
  \verb!wc_res! & 0.04 & -- & (PTF by \citet{rawls85}) \\ 
  \verb!wc_sat! & 0.39 & -- & PTF by \citet{woesten99} \\ 
  \verb!wstressmax! & 14000.00 & hPa & wilting point \\ 
