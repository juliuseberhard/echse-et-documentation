...
Additional meteorological data (measured at a height of 22~m) come from an eddy covariance tower (build by LI-COR Environmental) in the area (set up at UTM coordinates 557,689.5 easting, 4,332,375.0 northing; NSB\_TOWER in Fig.~\ref{fig:map_coruche}).
They include
\begin{denseitem}
  ...
  \item[--] wind speed,
  \item[--] wind direction,
  \item[--] sensible heat flux, including a quality flag following Foken \& Mauder,
  \item[--] latent heat flux, including a quality flag following Foken \& Mauder;
\end{denseitem}
%
...
For the sites in Portugal, the locations were given as UTM coordinates (HS: 557,640.5~m easting, 4,332,523.5~m northing; NSA: 557,717.0~m easting, 4,332,408.0~m northing; both in UTM zone~29S, see Fig.~\ref{fig:map_coruche}) from which I could derive $\varphi = 39.14^\circ$~N and $L_m= 8.33^\circ$~W for both field stations.
